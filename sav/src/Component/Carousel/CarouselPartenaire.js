                ...
                <Carousel variant="dark" style={{ marginBottom: '100px', marginTop: '100px'}}>
                    <Carousel.Item interval={100000}>
                        <div className="d-flex justify-content-around">
                            <Card id="icon-partenaire" style={{ marginLeft: '100px'}}>
                            ...
                            <Card id="icon-partenaire" style={{ marginRight: '100px'}}>
                        ...
                        <div className="d-flex justify-content-around">
                            ...
                            <Card id="icon-partenaire">
                                <a href="https://www.mr-bricolage.fr/Langeais/jardin/entretenir-le-jardin/tondre-et-couper.html">
                                    <Card.Img style={{ width: '300px', marginTop: '20px'}} src="https://www.dreamjob.ma/wp-content/uploads/2021/06/Mr.-Bricolage-Emploi-Recrutement.png"></Card.Img>
                                </a>
                            </Card>
                            <Card id="icon-partenaire" style={{ marginRight: '100px'}}>
                                <a href="https://www.bricomarche.com/c/entretien-du-jardin/outil-motorise-du-jardin/tondeuse-autoportee-et-robot-tondeuse/130257">
                                    <Card.Img style={{ width: '300px', marginTop: '70px'}} src="https://upload.wikimedia.org/wikipedia/fr/archive/2/22/20100107092431%21Bricomarch%C3%A9_logo_2009.png"></Card.Img>
                                </a>
                            </Card>
                        </div>
                    </Carousel.Item>
