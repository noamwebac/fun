        ...
        return(
            <div>
                <div className="d-flex justify-content-around">
                    <Card style={{ borderStyle: 'none', marginTop: '50px'}}>
                        <img style={{ width: '500px', height: '200px'}} src="https://www.sav03.shop/img/sav03-logo-1650785360.jpg"/>
                    </Card>
                    <Card style={{ width: '800px', marginBottom: '100px'}}>
